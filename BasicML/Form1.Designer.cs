...
namespace BasicML
{
    partial class FormBasicML
    {
        ...
        private void InitializeComponent()
        {
            ...
            // groupBox3
            // 
            groupBox3.Controls.Add(chooseFile6Button);
            ...
            // chooseFile6Button
            // 
            chooseFile6Button.Location = new Point(336, 20);
            chooseFile6Button.Margin = new Padding(2);
            chooseFile6Button.Name = "chooseFile6Button";
            chooseFile6Button.Size = new Size(128, 23);
            chooseFile6Button.TabIndex = 13;
            chooseFile6Button.Text = "Choose File (6 digit)";
            chooseFile6Button.UseVisualStyleBackColor = true;
            chooseFile6Button.Click += this.chooseFile6Button_Click;
            // 
            // saveAsButton
            // 
            ...
            // reloadFileButton
            // 
            reloadFileButton.Location = new Point(468, 20);
            ...
            chooseFileButton.Size = new Size(128, 23);
            chooseFileButton.TabIndex = 3;
            chooseFileButton.Text = "Choose File (4 digit)";
